...
#    Updated: 2024/10/07 16:15:58 by tmontani         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRCS    = $(SRCDIR)/main.c $(SRCDIR)/Prompt/prompt.c $(SRCDIR)/Parsing/dollars_utils.c $(SRCDIR)/Parsing/lexer.c $(SRCDIR)/Parsing/quotes_utils.c \
				...
				$(SRCDIR)/Exec/exec.c $(SRCDIR)/Exec/utils.c $(SRCDIR)/Exec/pipe_utils.c $(SRCDIR)/Exec/utils2.c $(SRCDIR)/Exec/builtins/pwd.c $(SRCDIR)/Exec/builtins/echo.c $(SRCDIR)/Exec/builtins/exit.c
